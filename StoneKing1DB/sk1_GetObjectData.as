// GetObjectData.as
// Stone King v1.0 AS2 original code.
// This ActionScript 2 file contains the raw factory pattern used directly in the game.
// The core of the data in the API resides from the data here.
...
function getObjectData(object, objectVariable) {
	...
	else if( object == "spell_fire" )
	{
		...
		O.Rlevel = 1;
		O.cost = 50;
		return ( O [ objectVariable ] ); // This is the weirdest thing: With only spell fire, it doesn't return a value. So i must put this here.
	}
	...
	else if ( object == "spell_heal" )
	{
		...
		O.C = "[ A ] [ A ] [ D ] [ W ] [ S ] [ W ] [ D ]";
		O.healFunction = function ( ):Void
		{
			var gainedAmount:Number = 5 + random ( 21 );
	...
	else if ( object == "spell_greaterHeal" )
	{
		...
		O.healFunction = function ( ):Void
		{
			var gainedAmount:Number = 15 + random ( 86 );
			if(health + gainedAmount > maxHealth)
			gainedAmount = maxHealth - health;
			boostStat("health", gainedAmount, "You heal "+gainedAmount+" health.");
			if ( inBattle ) 
	...
	else if ( object == "spell_omegaHeal" )
	{
		...
		O.healFunction = function ( ):Void
		{
			var gainedAmount:Number = 50 + random ( 151 );
			if(health + gainedAmount > maxHealth)
			gainedAmount = maxHealth - health;
			boostStat("health", gainedAmount, "You heal "+gainedAmount+" health.");
			if ( inBattle ) 
	...
	else if ( object == "spell_ultimateHeal" )
	{
		...
		O.healFunction = function ( ):Void
		{
			var gainedAmount:Number = 125 + random ( 301 );
			if(health + gainedAmount > maxHealth)
			gainedAmount = maxHealth - health;
			boostStat("health", gainedAmount, "You heal "+gainedAmount+" health.");
			if ( inBattle ) 
	...
	// Potionss
		...
		O.U = function() {
			var gainedAmount:Number = 4 + random(4);
			if(health + gainedAmount > maxHealth)
			gainedAmount = maxHealth - health;
			boostStat("health", gainedAmount, "You recover "+gainedAmount+" health.");
			minusItem(object);
		...
		O.U = function() {
			...
			var gainedAmount:Number = 4 + random(12);
			if(health + gainedAmount > maxHealth)
			gainedAmount = maxHealth - health;
			boostStat("health", gainedAmount, "You recover "+gainedAmount+" health.");
			minusItem(object);
		...
		O.U = function() {
			...
			var gainedAmount:Number = 10 + random(16);
			if(health + gainedAmount > maxHealth)
			gainedAmount = maxHealth - health;
			boostStat("health", gainedAmount, "You recover "+gainedAmount+" health.");
			minusItem(object);
		...
		O.U = function() {
			...
			var gainedAmount:Number = 25 + random(41);
			if(health + gainedAmount > maxHealth)
			gainedAmount = maxHealth - health;
			boostStat("health", gainedAmount, "You recover "+gainedAmount+" health.");
			minusItem(object);
		...
		O.U = function() {
			...
			var gainedAmount:Number = 50 + random(101);
			if(health + gainedAmount > maxHealth)
			gainedAmount = maxHealth - health;
			boostStat("health", gainedAmount, "You recover "+gainedAmount+" health.");
			minusItem(object);
		...
		O.U = function() {
			var gainedAmount:Number = 2 + random(9);
			if(energy + gainedAmount > maxEnergy)
			gainedAmount = maxEnergy - energy;
			boostStat("energy", gainedAmount, "You recover "+gainedAmount+" energy.");
			minusItem(object);
		...
		O.U = function() {
			...
			var gainedAmount:Number = 3 + random(11);
			if(energy + gainedAmount > maxEnergy)
			gainedAmount = maxEnergy - energy;
			boostStat("energy", gainedAmount, "You recover "+gainedAmount+" energy.");
			minusItem(object);
		...
		O.U = function() {
			...
			var gainedAmount:Number = 10 + random(26);
			if(energy + gainedAmount > maxEnergy)
			gainedAmount = maxEnergy - energy;
			boostStat("energy", gainedAmount, "You recover "+gainedAmount+" energy.");
			minusItem(object);
		...
		O.U = function() {
			...
			var gainedAmount:Number = 35 + random(56);
			if(energy + gainedAmount > maxEnergy)
			gainedAmount = maxEnergy - energy;
			boostStat("energy", gainedAmount, "You recover "+gainedAmount+" energy.");
			minusItem(object);
		...
		O.U = function() {
			...
			var gainedAmount:Number = 100 + random(201);
			if(energy + gainedAmount > maxEnergy)
			gainedAmount = maxEnergy - energy;
			boostStat("energy", gainedAmount, "You recover "+gainedAmount+" energy.");
			minusItem(object);
